...
//########################################################################################################################
function char_spells(&$sqlr, &$sqlc)
{
      ...
      if ($sqlc->num_rows($result))
      {
        $output .= '
              <table class="lined" style="width: 550px;">
                <tr align="right">
                  <td colspan="6">';
        $output .= generate_pagination('char_spells.php?id='.$id.'&amp;realm='.$realmid.'&amp;start='.$start.'', $all_record, $itemperpage, $start);
        $output .= '
                  </td>
                </tr>
                <tr>
        ...
        while ($spell = $sqlc->fetch_assoc($result))
        {
          $output .= '
                <tr>
                  <td align="right"><a href="'.$spell_datasite.$spell['spell'].'">'.$spell['spell'].'</a></td>
